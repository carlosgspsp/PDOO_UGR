...
//      # pasamos de turno
        juego.pasarTurno();  // PONER EN PRIVATE DE NUEVO

         SorpresaConvertirme sorpresa = new SorpresaConvertirme("me convierto");
...
public class Clase {
    ...
    private static int VARIABLEESTATICA = 6;

    private Clase() {
       
    }

   static public Clase getInstance() {
        return instance;
    }
